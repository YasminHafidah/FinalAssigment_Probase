<x-layoutMasuk>
    ...
    <div class="grid min-h-screen grid-cols-1 md:grid-cols-2">
        ...
        <div class="flex flex-col items-center justify-center p-6 md:p-12 bg-[#E8F1F2] md:order-first">
            <div class="w-full max-w-md">
                ...
                <div class="mt-5 items-center space-y-6">
                    <form class="space-y-6" action="{{ route('user.login') }}" method="POST">
                        @csrf
                        <div class="flex items-center space-x-3 rounded-2xl bg-[#E49273] px-5 py-2 shadow-lg">
                        ...
                        <div class="flex items-center space-x-3 rounded-2xl bg-[#E49273] px-5 py-2 shadow-lg">
                            <span class="flex items-center justify-center bg-[#8093F1] rounded-full shrink-0 p-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-7 md:h-7"
                    ...
                    <a href="{{ route('google.redirect') }}"
                        class="flex w-full items-center justify-center rounded-3xl border-2 border-[#0B132B] bg-transparent px-5 py-3 shadow-lg hover:bg-gray-100 transition-all">
                        <div class="flex items-center justify-center space-x-3">
                            <svg class="h-8 w-8 md:h-6 md:w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <path fill="#FFC107"
                            ...
                            <span class="text-center">Masuk/Daftar dengan akun Google</span>
                        </div>
                    </a>
                    <div>
